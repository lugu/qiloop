...
func (p *stubObject) RegisterEvent(msg *net.Message, c *bus.Channel) error {
...
func (p *stubObject) UnregisterEvent(msg *net.Message, c *bus.Channel) error {
	buf := bytes.NewBuffer(msg.Payload)
	objectID, err := basic.ReadUint32(buf)
	if err != nil {
		return c.SendError(msg, fmt.Errorf("cannot read objectID: %s", err))
...
func (p *stubObject) MetaObject(msg *net.Message, c *bus.Channel) error {
	buf := bytes.NewBuffer(msg.Payload)
	objectID, err := basic.ReadUint32(buf)
	if err != nil {
		return c.SendError(msg, fmt.Errorf("cannot read objectID: %s", err))
...
func (p *stubObject) Terminate(msg *net.Message, c *bus.Channel) error {
	buf := bytes.NewBuffer(msg.Payload)
	objectID, err := basic.ReadUint32(buf)
	if err != nil {
		return c.SendError(msg, fmt.Errorf("cannot read objectID: %s", err))
...
func (p *stubObject) Property(msg *net.Message, c *bus.Channel) error {
	buf := bytes.NewBuffer(msg.Payload)
...
func (p *stubObject) SetProperty(msg *net.Message, c *bus.Channel) error {
	buf := bytes.NewBuffer(msg.Payload)
	name, err := value.NewValue(buf)
	if err != nil {
		return c.SendError(msg, fmt.Errorf("cannot read name: %s", err))
...
func (p *stubObject) Properties(msg *net.Message, c *bus.Channel) error {
...
func (p *stubObject) RegisterEventWithSignature(msg *net.Message, c *bus.Channel) error {
	buf := bytes.NewBuffer(msg.Payload)
	objectID, err := basic.ReadUint32(buf)
	if err != nil {
		return c.SendError(msg, fmt.Errorf("cannot read objectID: %s", err))
...
func (p *stubObject) IsStatsEnabled(msg *net.Message, c *bus.Channel) error {
...
func (p *stubObject) EnableStats(msg *net.Message, c *bus.Channel) error {
	buf := bytes.NewBuffer(msg.Payload)
...
func (p *stubObject) Stats(msg *net.Message, c *bus.Channel) error {
...
func (p *stubObject) ClearStats(msg *net.Message, c *bus.Channel) error {
...
func (p *stubObject) IsTraceEnabled(msg *net.Message, c *bus.Channel) error {
...
func (p *stubObject) EnableTrace(msg *net.Message, c *bus.Channel) error {
	buf := bytes.NewBuffer(msg.Payload)
